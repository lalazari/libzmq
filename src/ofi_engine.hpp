...
#ifndef __ZMQ_OFI_ENGINE_HPP_INCLUDED__
#define __ZMQ_OFI_ENGINE_HPP_INCLUDED__
...
namespace zmq
{
    ...
    //  e.g. OFI socket or an UNIX domain socket.

    class ofi_engine_t : public io_object_t, public i_engine
    {
    public:
        ...
        ofi_engine_t (fd_t fd_, const options_t &options_,
    ...
    private:
        ...
        int (ofi_engine_t::*next_msg) (msg_t *msg_);

        int (ofi_engine_t::*process_msg) (msg_t *msg_);
        ...
        ofi_engine_t (const ofi_engine_t&);
        const ofi_engine_t &operator = (const ofi_engine_t&);
    };
