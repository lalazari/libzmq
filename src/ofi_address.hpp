...
#ifndef __ZMQ_OFI_ADDRESS_HPP_INCLUDED__
#define __ZMQ_OFI_ADDRESS_HPP_INCLUDED__
...
namespace zmq
{
    ...
    public:
        ...
        ofi_address_t ();
        ofi_address_t (const sockaddr *sa, socklen_t sa_len);
        virtual ~ofi_address_t ();

        //  This function translates textual OFI address into an address
    ...
    class ofi_address_mask_t : public ofi_address_t
    {
    public:
        ofi_address_mask_t ();

        // This function enhances ofi_address_t::resolve() with ability to parse
